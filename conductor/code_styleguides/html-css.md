# Project lint source of truth

For Träff HTML/CSS:

- Prefer existing theme tokens and layout patterns in the client being edited (`brfv2-mockup`, PWA, native styles)
- Accessibility and contrast matter for volunteer boards; use project e2e/a11y checks where present
- No root Prettier policy unless the project explicitly adopts one later

The guide below is a baseline; **local product UI conventions win** on conflicts.
